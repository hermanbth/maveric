...
class CCDeveloper extends CObject implements IController {
	...
	* Att skriva ut allt innehåll i CObject används vid debugging och felsökning.
	*/
...
<p>Here is the content of the controller, including properties from CObject which holds access to common resources in CMaveric.</p>
EOD;
