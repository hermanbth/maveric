 ...
 * Set database(s).
 */
$ma->config['database'][0]['dsn'] = 'sqlite:' . MAVERIC_SITE_PATH . '/data/.ht.sqlite';
...
$ma->config['menus'] = array(
  ...
  'my-navbar' => array(
	...
	'gallery'   => array('label'=>'Gallery', 'url'=>'my/gallery'),
  ),
);
 ...
 * Template files can reside in the parent or current theme, the CMaveric::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly MAVERIC_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
