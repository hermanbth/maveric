...
class CDatabase {
  ...
  public function ExecuteSelectQueryAndFetchAll($query, $params=array()){
	...
	// I sk loggning håller klassen ordning på antalet anrop som gjorts till databasen och vilka frågor som ställts.
	// Bra utvecklingsverktyg och kan vara till stor hjälp vid felsökning.
	self::$queries[] = $query;
	self::$numQueries++;
