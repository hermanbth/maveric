<?php
/**
 * A model for managing Maveric modules.
 * 
 * @package MavericCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $mavericCoreModules = array('CMaveric', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $mavericCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isMavericCore']   = in_array($rc->name, $this->mavericCoreModules);
      $details['isMavericCMF']    = in_array($rc->name, $this->mavericCMFModules);
