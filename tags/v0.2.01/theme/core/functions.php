...
$maveric->data['header'] = '<h1>Header: Maveric</h1>';
$maveric->data['footer'] = <<<EOD
 
<p>Footer: &copy; Maveric</p>
...
<a href="http://validator.w3.org/i18n-checker/check?uri={$maveric->request->currentUrl}">i18n</a>
<a href="http://validator.w3.org/checklink?uri={$maveric->request->currentUrl}">Links</a>
</p>
